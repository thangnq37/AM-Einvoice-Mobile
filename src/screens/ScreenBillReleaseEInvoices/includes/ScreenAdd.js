      ...
      <Content padder>
        <Form>
          ...
          <Item stackedLabel>
            ...
            <Input
              value={checkUndefined(data.FORM_SYMBOL)}
              onChangeText={(e) => {
          ...
          <Item stackedLabel>
            ...
            <Input
              value={checkUndefined(data.BILL_SYMBOL)}
              onChangeText={(e) => {
          ...
          <Item stackedLabel>
            ...
            <Input
              value={checkUndefined(data.FROM_NUM)}
              placeholder="Từ"
              onChangeText={(e) => {
            ...
            />
            <Input
              value={checkUndefined(data.TO_NUM)}
              placeholder="Đến"
              onChangeText={(e) => {
          ...
          <Item stackedLabel>
            <Label>Tổng số</Label>
            <Input
              value={checkUndefined(data.RELEASE_COUNT)}
              onChangeText={(e) => {
